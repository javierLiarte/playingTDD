...
public class _StockMarketYearTest {
	...
	public void startingValues() {
		...
		assertEquals("Capital gain tax rate", CAPITAL_GAINS_TAX, year.capitalGainsTaxRate());
	...
	public void capitalGainsTax() {
		...
		assertEquals("capital gains tax includes tax on withdrawals to cover capital gains", new Dollars(250 + 83), year.capitalGainsTaxIncurred());
		assertEquals("total withdrawn includes capital gains tax", new Dollars(4000 + 250 + 83), year.totalWithdrawn());
	}
	...
	public void endingPrincipal() {
		...
		assertEquals("principal considers withdrawals", new Dollars(2000), year.endingPrincipal());
	...
	public void endingBalance() {
		StockMarketYear year = newYear();
		assertEquals("ending balance includes interest rate", new Dollars(11000), year.endingBalance());
		year.withdraw(new Dollars(1000));
	...
	private StockMarketYear newYear() {
		return new StockMarketYear(STARTING_BALANCE, STARTING_PRINCIPAL, INTEREST_RATE, CAPITAL_GAINS_TAX);
	}
