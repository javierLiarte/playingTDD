...
public class _StockMarketYearTest {
	...
	private static final int CAPITAL_GAINS_TAX = 25;
	...
	public void capitalGainsTax() {
		StockMarketYear year = newYear();
		year.withdraw(4000);
		assertEquals("capital gains tax includes tax on withdrawals to cover capital gains", 250 + 83, year.capitalGainsTaxIncurred());
		assertEquals("total withdrawn includes capital gains tax", 4000 + 250 + 83, year.totalWithdrawn());
	}
	...
	public void endingBalance() {
		StockMarketYear year = newYear();
		assertEquals("ending balance includes interest rate", 11000, year.endingBalance());
		year.withdraw(1000);
